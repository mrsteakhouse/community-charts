...
![Version: 1.16.47](https://img.shields.io/badge/Version-1.16.47-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.23.3](https://img.shields.io/badge/AppVersion-2.23.3-informational?style=flat-square)
...
| main.pdb | object | `{"enabled":true,"maxUnavailable":1,"minAvailable":null}` | Whether to enable the PodDisruptionBudget for the main pod. |
...
| webhook.pdb | object | `{"enabled":true,"maxUnavailable":1,"minAvailable":null}` | Whether to enable the PodDisruptionBudget for the webhook pod |
...
| worker.pdb | object | `{"enabled":true,"maxUnavailable":1,"minAvailable":null}` | Whether to enable the PodDisruptionBudget for the worker pod |
